...
return()=>{
  ...
  return (
    ...
    ${sticky?"sticky-navbar shadow-md bg-grey-200 dark:bg-slate-600 dark:text-white duration-300 transition-all ease-in-out":""}`}>
  ...
  <div className="navbar-start">
    ...
    <a className="btn-ghost text-xl">Bookshelf</a>
  </div>
